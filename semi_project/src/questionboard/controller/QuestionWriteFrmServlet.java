 ...
 */
@WebServlet(name = "QuestionWriteFrm", urlPatterns = { "/questionWriteFrm" })
public class QuestionWriteFrmServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.getRequestDispatcher("/WEB-INF/views/question/questionWrite.jsp").forward(request, response);
	}
